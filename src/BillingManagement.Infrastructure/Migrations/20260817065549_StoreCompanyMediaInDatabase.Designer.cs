...
namespace BillingManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260817065549_StoreCompanyMediaInDatabase")]
    partial class StoreCompanyMediaInDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BillingManagement.Infrastructure.CompanyMedia.CompanyMediaFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CompanyMedia", null, t =>
                        {
                            t.HasCheckConstraint("CK_CompanyMedia_Length", "[Length] = DATALENGTH([Content])");
                        });
                });
